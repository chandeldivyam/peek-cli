...
export function renderAgentHelp(topic: 'root' | 'create' | 'image' | 'video' = 'root'): string {
  const commandExamples = [
    ...
    'peek create image --provider openrouter --model seedream "A polished campaign visual"',
  ...
  const create = [
    ...
    '- `--provider openrouter` uses ByteDance Seedream for images and OpenRouter video-generation models.',
  ...
  const image = [
    ...
    '- peek create image --provider openrouter --model seedream "Premium coffee campaign art"',
